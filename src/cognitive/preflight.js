...
export function publicPreflightView(run) {
  return {
    ...
    transmissionPolicy: "Only these reviewed packets may be sent to approved providers. Raw code, configuration and tabular values remain local; provider packets contain only their versioned deterministic summaries.",
