...
export function publicPreflightView(run) {
  return {
    ...
    transmissionPolicy: "Only these reviewed packets may be sent to approved providers. Raw code and configuration remain local; provider packets contain only their versioned deterministic summaries.",
